...
class RpgFichaController extends Controller
{
    ...
    {
        $fichas = RpgFicha::all();
        return view('rpg_fichas.index', compact('fichas'));
    }
